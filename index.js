...
document.getElementsByTagName("textarea")[0].onkeyup = function(){
  ...
  document.querySelector ('li[data-testid="word-count"]').innerText = 'Recuento de palabras: '+ analyzer.getWordCount (text1);
  ...
  document.querySelector ('li[data-testid="number-sum"]').innerText = 'Longitud media de las palabras:' +ru analyzer.getAverageWordLength (text1);
}   
